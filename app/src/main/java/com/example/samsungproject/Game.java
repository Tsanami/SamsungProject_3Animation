...
public class Game extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void draw(Canvas canvas) {
        ...
        if(isFirstDraw){
            ...
            joystickWalk = new Joystick(275, 660, 140, 80, context);
            joystickGun = new Joystick(1550, 660, 140, 80, context);
            ...
            joystickGun = new Joystick(ws - ws/4, (int)(hs-(hs/5)), 140, 80, context);
            shop = new Shop(ws, hs);
